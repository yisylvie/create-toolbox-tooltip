...
public class ToolboxPreviewProvider extends BlockEntityPreviewProvider {
	...
	/**
	 * If the toolbox is stackable, the Inventory tag
	 * doesn't exist (and thus we will not show tooltips)
	 * It seems as though a toolbox loses its
	 * stackability when placed in the world
	 */
